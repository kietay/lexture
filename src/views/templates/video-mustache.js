...
$(document).ready(function () {
    ...
    $(html).filter('title').html(renderedTitle);

    var breadcrumb = $(".breadcrumb-bar").html();
    Mustache.parse(breadcrumb);
    var renderedBreadcrumb = Mustache.render(breadcrumb, variableData);
    $(".breadcrumb-bar").html(renderedBreadcrumb);
});